    ...
    <>
     ...
     <div className={styles.homeContainer}>
      <div className={styles.cardContainer}>
        <Alien size={150} color="#000000" weight="thin" />
      ...
      <div className={styles.cardContainer}>
        <BracketsCurly size={150} color="#000000" weight="thin"/>
      ...
      <div className={styles.cardContainer}>
        <AddressBook size={150} color="#000000" weight="thin"/>
...
/*<h1>UM TEXTO QUALQUER NA MINHA PAGINA</h1>*/